...
const Community = () => {
  return (
    <section id="comunidad" className="py-20 md:py-28 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold px-8 py-6 text-lg rounded-2xl shadow-ghosty-md hover:shadow-glow transition-all duration-300"
              >
                <a
                  href="https://discord.gg/g8dth9ttxr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3"
                >
